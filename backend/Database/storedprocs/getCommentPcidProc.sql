...
AS
BEGIN
		    SELECT c.commentid, c.postid, c.commentbdy, c.userid, u.username , u.profilepic, c.parentcomment, (select userid from commentlikes where userid = @userid and commentid = c.commentid) as curuserliked, COUNT(l.likeid) AS likes FROM comment c 
